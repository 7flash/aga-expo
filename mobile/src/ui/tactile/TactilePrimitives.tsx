...
const rivet = {
  ...
  shadowColor: relic.colors.shadow,
  shadowOpacity: 0.8,
  shadowRadius: 5,
};
...
const styles = StyleSheet.create({
  panelShell: {
    borderRadius: relic.material.panelRadius,
    backgroundColor: relic.colors.panelRaised,
    borderWidth: 1,
    borderColor: '#29383a',
    padding: 16,
    overflow: 'hidden',
  ...
  panelPatina: { ...StyleSheet.absoluteFillObject, backgroundColor: relic.colors.oxidizedCopper },
  panelTopLip: { position: 'absolute', left: 5, right: 5, top: 3, height: 2, borderRadius: 99, backgroundColor: 'rgba(255,255,255,0.25)' },
  panelBevel: { ...StyleSheet.absoluteFillObject, borderRadius: relic.material.panelRadius, borderTopWidth: 2, borderLeftWidth: 2, borderTopColor: 'rgba(255,255,255,0.11)', borderLeftColor: 'rgba(255,255,255,0.06)', borderBottomWidth: 5, borderRightWidth: 4, borderBottomColor: 'rgba(0,0,0,0.76)', borderRightColor: 'rgba(0,0,0,0.58)' },
  ...
  panelTitle: { color: relic.colors.engraved, fontSize: 10, letterSpacing: 2.3, textTransform: 'uppercase', fontWeight: '900', marginBottom: 12, paddingLeft: 8 },

  buttonBody: { minHeight: 82, borderRadius: relic.material.controlRadius, backgroundColor: '#132022', borderWidth: 1, borderColor: '#344648', paddingVertical: 13, paddingHorizontal: 15, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.62, shadowRadius: 12, shadowOffset: { width: 0, height: 7 }, minWidth: 160 },
  buttonPatina: { ...StyleSheet.absoluteFillObject, backgroundColor: relic.colors.copperDark },
  ...
  buttonBevel: { ...StyleSheet.absoluteFillObject, borderTopWidth: 3, borderLeftWidth: 2, borderTopColor: 'rgba(255,255,255,0.22)', borderLeftColor: 'rgba(255,255,255,0.10)', borderBottomWidth: 5, borderRightWidth: 4, borderBottomColor: 'rgba(0,0,0,0.82)', borderRightColor: 'rgba(0,0,0,0.62)', borderRadius: relic.material.controlRadius },
  buttonGrain: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(255,255,255,0.7)' },
  buttonIndex: { color: relic.colors.amber, fontWeight: '900', fontSize: 12, letterSpacing: 1.7, marginBottom: 2, textShadowColor: 'rgba(240,174,63,0.45)', textShadowRadius: 8 },
  buttonLabel: { color: relic.colors.coolWhite, fontWeight: '900', fontSize: 17, letterSpacing: 0.3 },
  buttonSub: { color: relic.colors.engraved, fontSize: 12, lineHeight: 16, marginTop: 5, fontWeight: '700' },
  ...
  switchPatina: { ...StyleSheet.absoluteFillObject, backgroundColor: relic.colors.oxidizedCopper },
  switchLabel: { color: relic.colors.coolWhite, fontWeight: '900', fontSize: 14, flex: 1, paddingRight: 12 },
  ...
  rotaryLabel: { color: relic.colors.engraved, fontWeight: '900', fontSize: 10, letterSpacing: 1.6, textTransform: 'uppercase' },
  ...
  rotaryNeedle: { width: 6, height: 24, borderRadius: 4, backgroundColor: relic.colors.wornEdge, shadowOpacity: 0.9, shadowRadius: 8 },
  rotaryValue: { color: relic.colors.coolWhite, fontSize: 12, fontWeight: '900', marginTop: 9 },
  ...
  gaugeLabel: { color: relic.colors.engraved, fontSize: 9, fontWeight: '900', letterSpacing: 1.4, textTransform: 'uppercase' },
  ...
  gaugeValue: { color: relic.colors.coolWhite, fontSize: 13, fontWeight: '900' },
  ...
  messageRole: { color: relic.colors.amber, fontSize: 9, fontWeight: '900', letterSpacing: 1.6, textTransform: 'uppercase', marginBottom: 5 },
  messageText: { color: relic.colors.coolWhite, fontSize: 13, lineHeight: 18, fontWeight: '700' },
