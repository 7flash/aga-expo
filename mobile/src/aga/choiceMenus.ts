...
export function buildChoiceMenu(kind: string | null | undefined): ChoiceMenu {
  ...
  if (normalized === 'skills' || normalized === 'session') {
    return menu('skills', 'Choose a skill', 'Say a number or skill name. AGA will switch modes.', [
      { key: '1', label: 'Language learning', description: 'practice with corrections', aliases: ['language', 'learn'], action: { type: 'show_menu', menu: 'language' } },
      { key: '2', label: 'Imagination game', description: 'voice-only story play', aliases: ['imagination', 'adventure', 'game'], action: { type: 'show_menu', menu: 'imagination' } },
      { key: '3', label: 'Calm advice', description: 'short supportive guidance', aliases: ['advice', 'calm'], action: { type: 'start_session', kind: 'advice', label: 'Calm advice session', theme: 'calm advice' } },
      { key: '4', label: 'Focus coach', description: 'choose one task and begin', aliases: ['focus', 'coach', 'work'], action: { type: 'start_session', kind: 'focus', label: 'Focus coaching session', theme: 'deep work' } },
      { key: '5', label: 'Breathing guide', description: 'slow nervous-system reset', aliases: ['breathing', 'breathe'], action: { type: 'start_session', kind: 'breathing', label: 'Breathing guide', theme: 'breathing' } },
      { key: '6', label: 'Bedtime story', description: 'soft sleep-friendly narration', aliases: ['bedtime', 'story', 'sleep'], action: { type: 'start_session', kind: 'bedtime', label: 'Bedtime story session', theme: 'sleep story' } },
      { key: '7', label: 'Music companion', description: 'ambient music plus quiet conversation', aliases: ['music', 'ambient'], action: { type: 'start_session', kind: 'music', label: 'Music companion session', theme: 'ambient music' } },
      { key: '8', label: 'General guardian', description: 'normal AGA mode', aliases: ['general', 'normal'], action: { type: 'start_session', kind: 'general', label: 'General guardian session' } },
    ]);
  }
  ...
  return menu('main', 'AGA settings', 'No buttons. Say a number, letter, or option name.', [
    ...
    { key: 'C', label: 'Choose a skill', description: 'language, game, focus, bedtime, breathing', aliases: ['skill', 'skills'], action: { type: 'show_menu', menu: 'skills' } },
