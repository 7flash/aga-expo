...
export type GuidedSessionStateRow = {
  id: string;
  presetId: string;
  kind: string;
  label: string;
...
export type HabitObservationRow = {
  id: number;
  kind: string;
  label: string;
...
export type ScenarioPatternRow = {
  id: number;
  patternKey: string;
  label: string;
  triggerJson: string | null;
  ...
  confidence: number;
  consentState: 'observed' | 'proposed' | 'accepted' | 'dismissed' | string;
  lastObservedAt: string;
  createdAt: string;
  updatedAt: string;
};

export type SoundscapePreferenceRow = {
  id: number;
  kind: string;
  label: string;
  useCase: string | null;
