...
export async function migrate() {
  ...
  await db.execAsync(`
    ...
    CREATE TABLE IF NOT EXISTS guided_session_state (
      id TEXT PRIMARY KEY NOT NULL,
      ...
      userResponsesJson TEXT NOT NULL DEFAULT '[]',
      lastCue TEXT,
    ...
    CREATE TABLE IF NOT EXISTS scenario_patterns (
      ...
      confidence REAL NOT NULL DEFAULT 0.5,
      consentState TEXT NOT NULL DEFAULT 'observed',
      lastObservedAt TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
      createdAt TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
      updatedAt TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
    );
    ...
    CREATE TABLE IF NOT EXISTS soundscape_preferences (
      ...
      label TEXT NOT NULL,
      useCase TEXT,
      volume INTEGER NOT NULL DEFAULT 42,
      confidence REAL NOT NULL DEFAULT 0.5,
      createdAt TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
      updatedAt TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
    );
    ...
    CREATE INDEX IF NOT EXISTS idx_guided_state_updated ON guided_session_state(updatedAt);
    CREATE INDEX IF NOT EXISTS idx_habit_observations_created ON habit_observations(kind, createdAt);
    CREATE UNIQUE INDEX IF NOT EXISTS idx_scenario_patterns_key ON scenario_patterns(patternKey);
    CREATE INDEX IF NOT EXISTS idx_scenario_patterns_consent ON scenario_patterns(consentState, confidence, updatedAt);
    CREATE INDEX IF NOT EXISTS idx_soundscape_preferences_kind ON soundscape_preferences(kind, confidence, updatedAt);
